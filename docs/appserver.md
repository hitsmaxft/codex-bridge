...
| `thread/resume`, `thread/unsubscribe`                                                | Acquire and release per-thread writer ownership while keeping a bounded LRU set of event subscriptions. An active-writer conflict is a read-only session state, not a connection failure.                                                        |
